...
def main(env_name, env_short_name, new_epoch):
    ...
    act = deepq.load_with_scope_retrain_for_play(model_name, my_scope)
...
'''
python3 enjoy_depgraph_data_vs_mixed_with_retrain.py DepgraphJavaEnvVsMixedAtt29N-v0 sl29 15
'''
