...
def main(env_name, new_epoch):
    ...
    '''
    model_name = "depgraph_dq_mlp_rand_epoch_fromretrain" + str(new_epoch) + ".pkl"
    ...
    prefix_for_save = "depgraph_dq_mlp_rand_epoch_retrain" + str(new_epoch)
    retrain_config_str = "d30_epoch" + str(new_epoch) + "_att.tsv"
    deepq.learn_retrain_and_save(
        env,
        q_func=model,
        lr=5e-5,
        max_timesteps_init=10000,
        buffer_size=3000,
