...
class DepgraphJavaEnvVsMixedDef29N(gym.Env):
    ...
    def _reset(self):
        ...
        IS_HEURISTIC_DEFENDER = DepgraphJavaEnvVsMixedDef29N.is_heuristic_strategy(cur_def_strat)
        ...
        IS_DEF_TURN = True
        def_obs = DepgraphJavaEnvVsMixedDef29N.first_def_obs()
    ...
    def _step_vs_heuristic(self, action):
        ...
        return DepgraphJavaEnvVsMixedDef29N.step_result_from_list_heuristic( \
    ...
    def _step_vs_network(self, action):
        ...
        both_obs, is_done, state_dict, is_def_turn_local = \
            DepgraphJavaEnvVsMixedDef29N.step_result_from_list_network( \
                JAVA_GAME.step(action_id))
