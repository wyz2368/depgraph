...
class DepgraphJavaEnvConv(gym.Env):
    """
    ...
    def _step(self, action):
        ...
        return DepgraphJavaEnvConv.step_result_from_flat_list(JAVA_GAME.step(action_id))
    ...
    def step_result_from_flat_list(a_list):
        ...
        state_dict = {'state': obs_2darr[:]}
        return obs_2darr, reward, is_done, state_dict
