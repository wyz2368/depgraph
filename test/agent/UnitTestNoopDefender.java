...
public final class UnitTestNoopDefender {

	public UnitTestNoopDefender() {
		// default constructor
	}
	...
	public void canRunTest() {
		final String simspecFolderName = "testDirs/simSpecNoopDefender";
		...
		final NoopDefender testDefender =
			(NoopDefender) AgentFactory.createDefender(defenderName, defenderParams, simSpec.getDiscFact());
