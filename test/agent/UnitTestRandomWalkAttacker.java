...
public final class UnitTestRandomWalkAttacker {

	public UnitTestRandomWalkAttacker() {
		// default constructor
	}
	...
	public void canRunTest() {
		final String simspecFolderName = "testDirs/simSpecRandomWalkAtt";
		...
		final RandomWalkAttacker testAttacker =
			(RandomWalkAttacker) AgentFactory.createAttacker(attackerName, attackerParams, simSpec.getDiscFact());
	...
	public void allNodesAttackedTest() {
		...
		final Attacker valuePropAtt =
			new RandomWalkAttacker(10, 0.10, 1.0);
