...
def main(env_name, env_short_name, new_epoch, att_port, port_lock_name, env_short_name_tsv, \
    ...
    deepq.learn_and_save(
        ...
        q_func=model,
        lr=5e-5,
        max_timesteps=max_timesteps_att,
        buffer_size=30000,
...
example: python3 train_dg_java_mlp_att_vs_mixed.py DepgraphJavaEnvVsMixedDef29N-v0 sl29 15 \
    25335 s29 sl29_randNoAndB 700000
'''
if __name__ == '__main__':
    if len(sys.argv) != 8:
        raise ValueError("Need 7 args: env_name_mixed_def, env_short_name, new_epoch, " + \
    ...
    MAX_TIMESTEPS_ATT = int(sys.argv[7])
