...
public class RandomWalkAttacker extends Attacker {
	public class RandomWalkTuple{
		int tAct = 0;
		double pAct = 0.0;
		List<Edge> preAct;
		public RandomWalkTuple(int tAct, double pAct, List<Edge> preAct){
			this.tAct = tAct;
			this.pAct = pAct;
			this.preAct = preAct;
		}
	 ...
	 *****************************************************************************************/
	public AttackerAction sampleAction(DependencyGraph depGraph,
...
//								sequenceList.add(preNode);
	...
	*****************************************************************************************/
	static double greedyCandidate(DependencyGraph depGraph, RandomWalkTuple[] rwTuples
			, AttackCandidate attCandidate, int numTimeStep, double discFact)
	{
...
//		Set<Node> sequenceSet = new HashSet<Node>();
	 ...
	 *****************************************************************************************/
	static double[] computecandidateProb(int totalNumCandidate, double[] candidateValue, double qrParam)
	{
